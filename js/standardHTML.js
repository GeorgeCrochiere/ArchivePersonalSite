    ...
    var headerText = `
        ...
        <div class="navbar" id="navbar">
            ...
            <div class="dropdown" onclick="dropToggle()">
                ...
                <a class="dark-text drop-hover dropdown-content" id="dropdownContent4" href="../pages/honors-perspectives.html">Perspectives</a>
            </div>
        </div>
        <!--Menu Selector-->
        <div class="collapse-nav" id="collapse-navbar">
            <div class="menu-content">
                ...
                <a class="dark-text-muted menu-dropdown-link" href="../pages/honors-perspectives.html" onclick="menuToggle()">Perspectives -</a>
            </div>
        </div>
    `;
